import { QuizQuestions } from "@/app/module/[id]/page";
import { IModuleListAccordion } from "@/components/Accordion";
...
export const navbarButtons = [
  ...
  export const moduleList: IModuleListAccordion[] = [
    {
      id: 1,
      title: 'Module 1',
      content: {
        metaverseLink:
          'https://youtu.be/BegnuVHCFg8?si=zi7aRo_-8MGWXeH2',
        path: '/module/1',
      },
    },
    {
      ...
      content: {
        metaverseLink:
          'https://youtu.be/XbDpdzvHEEs?si=FCyc0gKAq5WAkT4x',
        path: '/module/2',
      },
    },
    {
      ...
      content: {
        metaverseLink:
          'https://youtu.be/1iNp9k0xSkw?si=rFcAxY42Ei4P7hKx',
        path: '/module/3',
      },
    },
    {
      ...
      content: {
        metaverseLink:
          'https://youtu.be/CiRSR3rN6PE?si=R1Xc8BPDyQQe0RaP',
        path: '/module/4',
      },
    },
    {
      ...
      content: {
        metaverseLink:
          'https://youtu.be/Cudj1pjk2DM?si=ewTT_qjlJzYfISqz',
        path: '/module/5',
      },
    },
    {
      ...
      content: {
        metaverseLink:
          'https://youtu.be/dGzAVuXBXfA?si=MZ3gyrdHQjPMh5B2',
        path: '/module/6',
      },
    },
    {
      ...
      content: {
        metaverseLink:
          'https://youtu.be/vU2SZp1xjlg?si=6uQsSx_l-zEshHfG',
        path: '/module/7',
      },
    },
    {
      ...
      content: {
        metaverseLink:
          'https://youtu.be/iuP93zkmTkA?si=vjbY1ciiT8e5zlgm',
        path: '/module/8',
      },
    },
    {
      ...
      content: {
        metaverseLink:
          'https://youtu.be/jdbKPgZngd8?si=n5FEb97ewSDx7llz',
        path: '/module/9',
      },
    },
  ];
  ...
  export const module1: QuizQuestions[] = [
    {
      ...
      options: [
        ...
        'Web 2 is faster, while Web 3 is slower',
    ...
    {
      question: 'Who controls the flow of information and transactions in Web 2?',
      options: ['A central authority', 'Peer-to-peer nodes', 'Users'],
      answer: 'A central authority',
    },
  
    {
      question: "What is the main characteristic of Web 2's architecture?",
      options: ['Decentralized', 'Centralized', 'Hybrid'],
      answer: 'Centralized',
    },
    ...
    {
      question: 'Who controls what users can see and do online in Web 2?',
      options: ['Central authorities', 'Users', 'Government'],
      answer: 'Central authorities',
    },
  
    {
      question: 'What is the main goal of Web 3?',
      options: [
    ...
    {
      question: 'How does Web 3 handle the flow of information and transactions?',
      options: [
        'Through a central authority',
        'Through peer-to-peer nodes',
        'Through a group of chosen individuals',
      ],
      answer: 'Through peer-to-peer nodes',
    },
  
    {
      ...
      options: [
        ...
        'To avoid learning new skills and technologies',
      ],
      answer: 'To adopt a more analytical and proactive approach to the web',
    },
  
    {
      question: 'What is the main benefit of Web 3 over Web 2?',
      options: [
        'More control over data and how it is used',
        'More censorship on the internet',
        'More control over the flow of information and transactions',
      ],
      answer: 'More control over data and how it is used',
    },
  
    {
      question: 'What is the main disadvantage of Web 2?',
      options: [
        "The central authorities collect and monetize users' personal data without their consent",
        'The network is made up of many peer-to-peer nodes that validate transactions',
  ...
  export const module2: QuizQuestions[] = [
    {
  ...
  export const module3: QuizQuestions[] = [
    {
  ...
  export const module4: QuizQuestions[] = [
    {
  ...
  export const module5: QuizQuestions[] = [
    {
  ...
  export const module6: QuizQuestions[] = [
    {
  ...
  export const module7: QuizQuestions[] = [
    {
  ...
  export const module8: QuizQuestions[] = [
    {
  ...
  export const module9: QuizQuestions[] = [
    {
